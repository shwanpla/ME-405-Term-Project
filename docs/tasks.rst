...
.. centered::
   *System task diagram showing how cooperative tasks exchange data and control flags through shared variables and queues during autonomous operation.*
...
.. image:: _static/serial_task_fsm.png
   :width: 80%
   :align: center

.. centered::
   *Serial task FSM used to parse Bluetooth commands, coordinate calibration steps, and control trial start and stop conditions.*
...
.. image:: _static/motor_control_fsm.png
   :width: 80%
   :align: center

.. centered::
   *Motor control FSM used to enable the motor driver, zero the encoder, apply PWM effort, and continuously publish encoder position and velocity telemetry.*
...
.. image:: _static/closed_loop_control_fsm.png
   :width: 90%
   :align: center

.. centered::
   *Closed loop control FSM implementing PI velocity control with line following correction, calibration handling, rest mode, and heading based turning mode.*
...
.. image:: _static/encoder_heading_block.png
   :width: 85%
   :align: center

.. centered::
   *Encoder based odometry computation converting left and right wheel motion into forward distance and heading state used by navigation and turning control.*
...
.. image:: _static/navigation_overview.png
   :width: 95%
   :align: center

.. centered::
   *Navigation FSM overview showing how the course is executed as a sequence of line follow, force straight, and heading based turn segments with recovery logic triggered by bump events.*
...
.. image:: _static/bump_task.png
   :width: 70%
   :align: center

.. centered::
   *Bump sensor task behavior used to debounce contact detection and publish a single collision event to the navigation layer.*
...
.. image:: _static/imu_handler_fsm.png
   :width: 90%
   :align: center

.. centered::
   *IMU handler FSM managing BNO055 reset, calibration loading or manual calibration, calibration persistence, and steady state data availability over I2C.*
...
.. image:: _static/observer_block.png
   :width: 85%
   :align: center

.. centered::
   *Observer task structure showing state space estimation with Luenberger gain injection and RK4 numerical integration for discrete time execution.*
